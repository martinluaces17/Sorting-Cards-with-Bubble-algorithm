...
function generadorDeCartas() {
  ...
  //la variable containerCartas ya no va a ser null ya que mediante el querySelector la está llamando y ahí se ejecutaría el if
  //de la siguiente línea por lo tanto, ya no sería distinto de null
  ...
  if (containerCartas != null) {
    //con el if decimos que si containerCartas es distinto de null
  ...
  for (var i = 0; i < inputValue; i++) {
    ...
    console.log("Carta ", cartaGenerada); //y le pasamos como parametros las variables palo y numero que son quienes generarn de forma random esos numeros y figuras
